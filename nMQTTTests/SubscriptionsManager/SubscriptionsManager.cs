...
namespace NmqttTests.SubscriptionsManager
{
    public class SubscriptionsManagerTests
    {
        ...
        public void SubscriptionRequestCreatesPendingSubscription()
        {
            ...
            Nmqtt.SubscriptionsManager subs = new Nmqtt.SubscriptionsManager(chMock.Object);
            subs.RegisterSubscription<AsciiStringPublishDataConverter>(topic, qos, ((subTopic, subData) => { Console.WriteLine(subData.ToString()); return true; }));
        ...
        public void MultipleSubscriptionsForSamePendingThrowsException()
        {
            ...
            Assert.Throws<ArgumentException>(() => subs.RegisterSubscription<AsciiStringPublishDataConverter>(topic, qos, ((subTopic, subData) => { Console.WriteLine(subData.ToString()); return true; })));
        }
        ...
        public void AcknowledgedSubscriptionRequestCreatesActiveSubscription()
        {
            ...
            // run and verify the mocks were called.
            Nmqtt.SubscriptionsManager subs = new Nmqtt.SubscriptionsManager(chMock.Object);
            short subid = subs.RegisterSubscription<AsciiStringPublishDataConverter>(topic, qos, ((subTopic, subData) => { Console.WriteLine(subData.ToString()); return true; }));
            chMock.VerifyAll();
