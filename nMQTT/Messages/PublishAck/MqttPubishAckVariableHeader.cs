...
namespace Nmqtt
{
    ...
    /// </summary>
    internal sealed class MqttPublishAckVariableHeader : MqttVariableHeader
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="MqttConnectVariableHeader" /> class.
        /// </summary>
        public MqttPublishAckVariableHeader() {}

        /// <summary>
        ///     Initializes a new instance of the <see cref="MqttConnectVariableHeader" /> class.
        /// </summary>
        /// <param name="headerStream">A stream containing the header of the message.</param>
        public MqttPublishAckVariableHeader(Stream headerStream) {
        ...
        public override string ToString() {
            return
                String.Format("PublishAck Variable Header: MessageIdentifier={0}", MessageIdentifier);
        }
    }
}